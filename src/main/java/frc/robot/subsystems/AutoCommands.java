...
public class AutoCommands {
    ...
    PathConstraints Pathconstraint = new PathConstraints(Constants.MAX_SPEED, Constants.maxAcceleration, Units.degreesToRadians(540), Units.degreesToRadians(720));
